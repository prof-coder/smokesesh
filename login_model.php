...
<section class="loggy">
	<div class="titulo">Model Login</div>
...
<input type="hidden" name="accountType" value="model">
        <div class="olvido">
        	<div class="col"><a href="registration/model.php" title="Register">Register</a></div>
            <div class="col"><a href="lostpassword.php" title="Reset Password">Forgot Password?</a></div>
        </div>
