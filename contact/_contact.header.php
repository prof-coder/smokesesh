...
<li class="logo"><a href="https://sexysmokesesh.com/index.php"><img src="../images/sexy-sesh-logo-large.jpg" alt="Camscripts-logo" width="200" height="30" align="absmiddle" valign="top" /></a></li>

       
<li class="topmenu"><form action="../searchModel_ff.php" method="post" id="search">
  <input name="search" style="background-color:#fff;" type="text" size="40" placeholder="Search..." />
</form></li>



<li class="topmenu">
    <!--<a href="#" style="height:10px;line-height:10px;"><span>Category Search</span></a>-->
	<div class="submenu" style="width:<?=(120*$columns);?>px;">
<?php
foreach($cat_array as $cat)
{
...
<ul id="css3menu1" class="topmenu">
    ...
    <li class="topmenu"><a href="../registration/user.php" style="height:10px;line-height:10px;"></a></li>
	<li class="topmenu"><a href="../login_member.php" style="height:10px;line-height:10px;"></a></li> 
</ul>
