...
$sunday=implode('-',$_POST['sunday']);	
	...
	mysql_query("UPDATE chatmodels SET password='$db_pass' WHERE id = '$id' LIMIT 1");
        ...
        if($_POST['country']) { mysql_query("DELETE  from blockedcountry where model='$username' "); foreach($_POST['country'] as $cc) {mysql_query("INSERT INTO blockedcountry (model,cc)values('$username','$cc');");}  } 
...
.chosen-container .chosen-drop{background:#8F0000;}
</style>

<p></p>
<table width="1223" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#800000">
...
<form action="updateprofile.php" method="post" enctype="multipart/form-data" name="form2">
        ...
        <table width="775" height="307" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#8F0000">
      ...
      &nbsp;&nbsp;&nbsp;<?php if ( isset($errorMsg) && $errorMsg!=""){ echo $errorMsg; } ?>
          ...
          <tr>
            ...
            <td width="243" valign="top"><div align="center"><table width="95%" cellpadding="5" bgcolor="#333333"><img id="pic" src="../../models/<? echo $username; ?>/thumbnail.jpg" width="275" height="187"></table>
...
//document.write( webcam.get_html(700,477) );
document.write( webcam.get_html(910,620) );
</script>
...
<img src="../../images/flash-save-image.png" onclick="timeFunction(); webcam.upload();">
    
<img src="../../images/delete.png" onclick="webcam.reset()">
...
<form>
      ...
      <form name="form1" method="post" action="updateprofile.php">
        ...
        <table width="764" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#800000">
