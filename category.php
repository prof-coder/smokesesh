...
$select="select * from chatmodels c where not exists(select id from blockedcountry b where  b.model=c.user  and b.cc='$cc') and c.status='online' AND c.category='$cat' order by rand() limit 41;";
			$result = mysql_query($select);
   ...
   <div align="center" style="width:100%; float:left;">
          ...
          <div class="hoverbox" align="center"><a href="category.php?category=<?php echo $cat;?>"><br />
